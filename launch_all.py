...
def main():
	...
	router = [("P1",1),("P2",2),("P3",3),("P4",4),("P5",5),("P9",9),("P10",10),("P11",11)]
	links = [("P1","P2",2,1),("P2","P3",3,2),("P1","P3",3,1),("P9","P10",10,9),("P10","P11",11,10),("P9","P11",11,9),("P2","P9",9,2),("P4","P5",5,4),("P3","P4",4,3),("P5","P10",10,5),("P2","P5",5,2),("P4","P9",9,4)]
