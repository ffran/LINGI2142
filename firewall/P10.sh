#!/bin/bash
#firewall for router P10-Firewall
#flush older table
ip6tables -F INPUT
ip6tables -F OUTPUT
ip6tables -F
...
#allow traceroute6
ip6tables -I INPUT -p udp --dport 33434:33474 -j ACCEPT --match limit --limit  20/minute
...
ip6tables -A INPUT -i king2 -s fde4:9::/32 -j DROP
